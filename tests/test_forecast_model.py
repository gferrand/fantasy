...
def test_availability_is_source_required_and_minutes_only():
    ...
    assert signals[0]["forecast_expected_minutes_input"] == 40.0
    ...
    assert signals[0]["forecast_expected_minutes_input"] == 40.0  # unsourced finding ignored


def test_out_is_zero_and_gtd_stays_numeric_with_visible_label():
    players = [
    ...
    assert players[0]["forecast"]["points"] == 0.0
